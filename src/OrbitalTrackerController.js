define([], function () {
    function OrbitalTrackerController(data, orbitaltrackerModel, orbitaltrackerRenderer, domainObject, openmct) {
        this.data = data;
        this.orbitaltrackerModel = orbitaltrackerModel;
        this.orbitaltrackerRenderer = orbitaltrackerRenderer;
    ...
    OrbitalTrackerController.prototype.bounds = function (bounds, wasTick) {
        if (!wasTick) {
            this.refresh();
        }
    };

    OrbitalTrackerController.prototype.refresh = function () {
        var domainObject = this.domainObject;
        var requests = [];

        this.orbitaltrackerModel.clear();
    ...
    OrbitalTrackerController.prototype.datum = function (property, datum) {
        if (this.requesting) {
    ...
    OrbitalTrackerController.prototype.handleResponses = function (responses) {
    ...
    OrbitalTrackerController.prototype.flush = function () {
    ...
    OrbitalTrackerController.prototype.scheduleRendering = function () {
        if (!this.renderScheduled) {
            ...
            window.requestAnimationFrame(function () {
                ...
                this.updateView();
                this.orbitaltrackerRenderer.render(this.orbitaltrackerModel);
            }.bind(this));
        }
    };

    OrbitalTrackerController.prototype.updateView = function () {
        var xTicks = [];
        var yTicks = [];
        var bounds = this.orbitaltrackerModel.bounds();
        var x = bounds.x - 1;
        var y = bounds.y - 1;
    ...
    OrbitalTrackerController.prototype.destroy = function () {
    ...
    return OrbitalTrackerController;
});